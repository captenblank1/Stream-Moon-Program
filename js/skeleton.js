...
(function () {
  ...
  /* سكيلتون صفحة الشاشات — عنوان + شبكة 10 بطاقات (رقم + رابط + زر نسخ) */
  function screensPage() {
    var w = document.createElement('div');
    w.className = 'sk-scrwrap';

    var head = document.createElement('div');
    head.className = 'sk-scrhead';
    var t1 = document.createElement('div');
    t1.className = 'sk-line';
    ...
    var grid = document.createElement('div');
    grid.className = 'sk-scrgrid';
    for (var i = 0; i < 10; i++) {
      var card = document.createElement('div');
      card.className = 'sk-scrcard';
      var num = document.createElement('div');
      num.className = 'sk-scrnum';
      var url = document.createElement('div');
      url.className = 'sk-line';
      url.style.width = '100%';
      url.style.height = '16px';
      var btn = document.createElement('div');
      btn.className = 'sk-pill';
      btn.style.width = '100%';
