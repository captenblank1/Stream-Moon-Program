...
(function () {
  ...
  var EXACT = {
    ...
    "المشتركون (قلب الفريق) من مستوى": "Team Heart subscribers from level",
    "المشرفون (Mods) فقط": "Moderators only",
    "أفضل معجب (Top Fan) من مستوى": "Top Fan from level",
    "أفضل معجب (Top Fan)": "Top Fan",
    ...
    "نقاط لكل تكبيس/لايك (كل X لايكات = نقطة)": "Points per tap/like (every X likes = 1 point)",
    "نقاط لكل تكبيس (كل X لايكات = نقطة)": "Points per tap (every X likes = 1 point)",
    "نقاط لكل عملات (كل X عملات = نقطة)": "Points per coins (every X coins = 1 point)",
    "النقاط": "Points",
    ...
    "Top Viewers — أول": "Top Viewers — first",
    "وأعلى": "and above",
    ...
    "أقصى طول للطابور": "Max queue length",
